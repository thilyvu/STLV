					...
					if(maxacthuc.equals(xt.getMaxacthuc())&&xt.getTinhtrang().equals("0"))
					{
						if(Cdonhang.suadonhangbyid(xt.getId_donhang(), "2", "")>0)
						{
							...
							if(Cxacthucdonhang.suaxacthuc(xt)>0)
							{
								...
								body+="<br><a href=\"https://localhost:8080/stlv/cpayment?maxacthuc="+code+"&id="+id+"\"><button>Xác nhận đã giao</button></a>";
								body+="<br><a href=\"https://localhost:8080/stlv/cpayment?maxacthuc="+code+"&id="+id+"&huy=1\"><button>Khách hàng đã hủy nhận hàng</button></a>";
